...
namespace DAMLibTest
{
    ...
    {
        public delegate bool Delegate(string word);
        static void Main(string[] args)
        {
            ...
            */
            Set<string> setprueba = new Set<string>();
            setprueba.Add("Coche");
            setprueba.Add("Moto");
            setprueba.Add("Moto");            
            setprueba.Add("Camion");

            Console.WriteLine(setprueba.ToString());

            bool test = setprueba.Contains("Moto");
            int test2 = setprueba.IndexOf("Camion");

            List<string> list = new List<string>() { "elefante", "aguila", "farola","jirafa", "farola", "farola" };
