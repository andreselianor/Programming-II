namespace Figuras
{
    public class Triangulo : Planas
    {
        ...
        public Triangulo(string nombre, double Coordenada1X, double Coordenada1Y, double Coordenada2X, double Coordenada2Y) : base(nombre)
        {
